...
L["Disabling the texture will make them reset next time you relog, are you sure?"] = "Disabling the texture will make them reset next time you relog, are you sure?"
L["Sort"] = "Sort"
